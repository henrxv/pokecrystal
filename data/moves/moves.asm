...
; entries correspond to constants/move_constants.asm
	move SILVER_WIND,  EFFECT_ALL_UP_HIT,         80, BUG,      SPECIAL,  100, 10,  10
	...
	move DAZZLINGLEAM, EFFECT_NORMAL_HIT,         80, FAE,      SPECIAL,  100, 10,   0
	...
	move CUT,          EFFECT_ATTACK_UP_HIT,      50, STEEL,    PHYSICAL,  95, 35,  10
	...
	move NIGHT_DAZE,   EFFECT_ACCURACY_DOWN_HIT,  85, DARK,     SPECIAL,   95, 10,  40
	...
	move SUCKER_PUNCH, EFFECT_PRIORITY_HIT,       70, DARK,     PHYSICAL, 100, 15,   0
	move WRAP,         EFFECT_TRAP_TARGET,        15, NORMAL,   PHYSICAL,  85, 20,   0
	move LEAF_STORM,   EFFECT_DRACO_METEOR,      130, GRASS,    SPECIAL,   90,  5,   0
	...
	move OVERHEAT,     EFFECT_DRACO_METEOR,      130, FIRE,     SPECIAL,   90,  5,   0
	...
	move SHEER_COLD,   EFFECT_OHKO,                1, ICE,      SPECIAL,   30,  5,   0
	move STRENGTH,     EFFECT_PARALYZE_HIT,       85, NORMAL,   PHYSICAL, 100, 15,  30
	...
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,       100, FIRE,     SPECIAL,   75, 10,   0
	...
	move THROAT_CHOP,  EFFECT_NORMAL_HIT,         80, DARK,     PHYSICAL, 100, 15,   0
	move CHARGE_BEAM,  EFFECT_SP_ATK_UP_HIT,      50, ELECTRIC, SPECIAL,   90, 10, 100
	...
	move BOUNCE,       EFFECT_FLY,                85, FLYING,   PHYSICAL,  85,  5,  30
	...
	move FREEZE_DRY,   EFFECT_FREEZE_HIT,         70, DRY,      SPECIAL,  100, 20,  10
	...
	move MOONBLAST,    EFFECT_SP_ATK_DOWN_HIT,    95, FAE,      SPECIAL,  100, 15,  30
	...
	move DISARM_VOICE, EFFECT_ALWAYS_HIT,         40, FAE,      SPECIAL,  100, 15,   0
	move REST,         EFFECT_HEAL,                0, PSYCHIC,  STATUS,   100, 10,   0
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         75, ROCK,     PHYSICAL,  90, 10,  30
	move NIGHT_SLASH,  EFFECT_NORMAL_HIT,         70, DARK,     PHYSICAL, 100, 15,  10
	move PLAY_ROUGH,   EFFECT_ATTACK_DOWN_HIT,    90, FAE,      PHYSICAL,  90, 10,  10
	...
	move THIEF,        EFFECT_THIEF,              65, DARK,     PHYSICAL, 100, 20,   0
	...
	move DRACO_METEOR, EFFECT_DRACO_METEOR,      130, DRAGON,   SPECIAL,   90,  5,   0
	move AEROBLAST,    EFFECT_NORMAL_HIT,        100, FLYING,   SPECIAL,   95,  5,   0
	move SCALD, 	   EFFECT_SACRED_FIRE,        80, WATER,    SPECIAL,  100, 15,  30
	...
	move INFERNO,      EFFECT_BURN_HIT,          150, FIRE,     SPECIAL,   50,  5, 100
	move SWEET_KISS,   EFFECT_CONFUSE,             0, FAE,      STATUS,    75, 10,   0
	...
	move CHARM,        EFFECT_ATTACK_DOWN_2,       0, FAE,      STATUS,   100, 20,   0
	...
	move MOONLIGHT,    EFFECT_MOONLIGHT,           0, FAE,      STATUS,   100,  5,   0
	...
	move HURRICANE,    EFFECT_TWISTER,           110, FLYING,   SPECIAL,   70, 10,  30
	...
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   75, FIGHTING, PHYSICAL,  95, 10,  50
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,       100, WATER,    SPECIAL,   75, 10,   0
	...
	move SAND_TOMB,    EFFECT_TRAP_TARGET,       120, GROUND,   PHYSICAL,  75, 10,   0
