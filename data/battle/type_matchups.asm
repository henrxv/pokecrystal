TypeMatchups: ; 34bb1
	...
	db FIGHTING,  FAE,       NOT_VERY_EFFECTIVE
	...
	db DRAGON,    FAE,       NO_EFFECT
	db DARK,      FIGHTING,  NOT_VERY_EFFECTIVE
	db DARK,      PSYCHIC,   SUPER_EFFECTIVE
	db DARK,      GHOST,     SUPER_EFFECTIVE
	db DARK,      DARK,      NOT_VERY_EFFECTIVE
	db DARK,      FAE,       NOT_VERY_EFFECTIVE
	...
	db STEEL,     FAE,       SUPER_EFFECTIVE
	db FAE,       FIRE,      NOT_VERY_EFFECTIVE
	db FAE,       FIGHTING,  SUPER_EFFECTIVE
	db FAE,       POISON,    NOT_VERY_EFFECTIVE
